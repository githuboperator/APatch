...
registerDownloadTask(
    ...
    srcUrl = "https://github.com/githuboperator/KernelPatch/releases/download/$kernelPatchVersion/kpimg-android",
...
registerDownloadTask(
    ...
    srcUrl = "https://github.com/githuboperator/KernelPatch/releases/download/$kernelPatchVersion/kptools-android",
